...
public class IntoTheDeepLM3Auto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(0,0,0))
                        ...
                        .strafeToLinearHeading(new Vector2d(-15.5,16), Math.toRadians(90))
                        .waitSeconds(.25)
                        ...
                        .stopAndAdd(slides.slidesUp())
                        .stopAndAdd(extBack.slidePivotDrop())
                        .strafeToLinearHeading(new Vector2d(-22,9), Math.toRadians(45))
                        //second cycle
                        .stopAndAdd(extFront.transferExtend())
                        ...
                        .waitSeconds(.25)
                        .stopAndAdd(slides.slidesDown())
                        .strafeToLinearHeading(new Vector2d(-11,39), Math.toRadians(180))
                        .stopAndAdd(extFront.transferExtend())
                        .waitSeconds(.75)
                        .stopAndAdd(extFront.clawClose())
                        .waitSeconds(.25)
